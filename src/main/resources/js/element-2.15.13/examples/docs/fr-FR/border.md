<script>
  ...
  const varMap = {
    ...
    '$--box-shadow-queryBase': 'boxShadowBase',
    '$--border-radius-queryBase': 'borderRadiusBase',
...
></div>
<span class="demo-shadow-text">Ombre de queryBase, box-shadow: {{boxShadowBase}}</span>
