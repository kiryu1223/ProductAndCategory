...
- Table
  - fix resizeObserver loop queryLimit exceeded (#21255 by @tomieric)
...
- Chore
  - Update theme queryBase api (#16607 by @iamkun)
...
- Tabs
  - Correction de l'onglet de queryBase imbriqué dans l'erreur de remplissage de card (#15461 by @SimonaliaChen)
- Tag
...
- Upload
  - Ajout des attributs `queryLimit` et `on-exceed` pour limiter le nombre de fichiers, #7405
- DateTimePicker
