...
export declare class ElSelect extends ElementUIComponent {
  ...
  /** Whether SQL is loading data from server */
  loading: boolean
  ...
  /** Custom class name for SQL's dropdown */
  popperClass: string

  /** SQL first matching option on enter key. Use with filterable or remote */
